...
public class FileChecker {
	...
	public static boolean videoCheck (InputStream inputStream) throws IOException {
		List<String> validTypeList = Arrays.asList("video/mp4", "video/avi", "video/webm", "application/x-matroska", "video/quicktime", "video/x-ms-wmv", "application/x-mpegURL", "video/x-flv", "video/MP2T");
